...
export default function ProfileScreen({ ec = {} }: ProfileScreenProps) {
  const {
    bannerUrl = 'https://i.ytimg.com/vi/Fxm2cUNas1k/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLDAV7W1ADVrw5Vr9p3_v9zomhDIlw',
    avatarUrl = 'https://e.sport.fr/wp-content/uploads/2024/06/Gentle_Mates_beyAz_at_VCT_2024_EMEA_Kickoff.jpg',
    valoThumbUrl = 'https://gamecover.fr/wp-content/uploads/Tejo-Act-1-Wallpaper.png',
    name = 'beyAz',
    teamName = 'GentleMates',
    description = `Content Creator - VALORANT
Ex-Joueur Professionnel dans la section VALORANT de l'équipe GentleMates`,
    colorTeam = COLORS.gentle_mates,
    youtubeUrl = 'https://www.youtube.com/@beyAzkorpe',
    twitchUrl = 'https://www.twitch.tv/beyaz'
  } = ec
        ...
        <View style={styles.profileInfoContainer}>
          ...
          <View style={styles.profileTextContainer}>
            ...
            <Text style={styles.profileTeam}>
              Équipe :{' '}
              <Text style={[styles.highlightTeam, { color: colorTeam }]}>
                {teamName}
              </Text>
            </Text>
        ...
        <View style={styles.postsContainer}>
          ...
          <View style={styles.postsRow}>
            <View style={styles.postCard}>
              <Image
                source={{ uri: valoThumbUrl }}
                style={styles.postImageBackground}
              />
              <LinearGradient
                colors={[colorTeam, 'rgba(108, 194, 53, 0)']}
                start={{ x: 0.5, y: 0 }}
                end={{ x: 1, y: 0 }}
            ...
            <View style={[styles.recruitCard, { backgroundColor: colorTeam }]}>
              <Unicons.UilRepeat
                size={15}
